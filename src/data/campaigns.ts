...
export const CAMPAIGNS: Campaign[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    description: 'Hari ini masih ada santri yang bergantung pada kebaikan kita untuk bisa makan dan terus menghafal Al-Qur\u2019an. Donasi Anda langsung membeli beras, lauk, susu, dan vitamin santri.',
    ogTitle: 'Mereka Menjaga Al-Qur\u2019an, Mari Kita Jaga Makan Mereka',
    ogDescription: 'Hari ini masih ada santri yang bergantung pada kebaikan kita untuk bisa makan dan terus menghafal Al-Qur\u2019an.',
    heroImage: '/images/drive-new/santri-makan.webp',
    badge: 'Program Pangan Santri — Rutin Bulanan',
    stats: [
      { value: '250', label: 'Santri Hafidz Butuh Makan' },
      { value: 'Rp 50rb', label: 'Cukup untuk 1 Santri 3 Hari' },
    ],
    stories: [
      {
        icon: '🍚',
        title: 'Lapar Bukan Alasan untuk Berhenti Hafal',
        body: 'Sejak subuh hingga malam, santri penghafal Qur\'an butuh energi. Tanpa gizi cukup, konsentrasi mereka buyar dan hafalan terhambat. Anda bisa mengubah perut kosong mereka menjadi kenyang.',
      },
      {
        icon: '📊',
        title: 'Transparansi Penuh',
        body: 'Seluruh donasi tercatat dan dilaporkan. Setiap pembelian beras, lauk, sayur, hingga gas dapur — semuanya teraudit dan bisa Anda akses kapan saja.',
      },
      {
        icon: '🤲',
        title: 'Pahala Berkelanjutan',
        body: 'Setiap suapan yang sampai ke santri adalah amal jariyah. Satu porsi makanan hari ini menjadi energi untuk menghafal ayat-ayat Allah.',
      },
    ],
    ...
    hook: 'Mereka Menjaga Al-Qur\'an. Mari Kita Jaga Makan Mereka.',
    masalah: [
      { icon: '🍚', title: 'Persediaan Beras Mulai Menipis', body: 'Persediaan beras untuk pekan depan masih kurang. Dengan harga yang terus naik, dapur harus pintar mengatur menu. Kalau stok habis, 250 santri bisa belajar dalam keadaan lapar.' },
      { icon: '🤲', title: 'Padahal Pahalanya Berlipat', body: 'Memberi makan penghafal Qur\'an adalah amal jariyah. Setiap suapan yang sampai ke santri menjadi pahala yang terus mengalir. Mulai Rp 50.000 — setara makan 1 santri 3 hari.' },
    ],
    tokoh: {
      name: 'Fatonah',
      age: '14 tahun',
    ...
    cta: 'Hari Ini Anda Bisa Jadi Alasan Seorang Santri Tetap Kuat',
    testimoni: [
    ...
    campaignUpdate: {
      status: 'berjalan',
      progress: 55,
      note: 'Persediaan beras mulai menipis. Harga terus naik — Rp 13.500/kg — sementara donasi bulan ini baru terkumpul 55% dari target. Kalau stok habis, dapur harus mengurangi porsi atau merekayasa menu seadanya.',
      date: 'Juli 2026',
      urgent: true,
    },
    accent: 'emerald',
